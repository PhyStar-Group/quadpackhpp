...
namespace quadpack {
    ...
    T_real Quadpack<T_fun, T_real>::qng(T_fun f, T_real user_data[], T_real a, T_real b, T_real epsabs, T_real epsrel, T_real* abserr, int* neval, int* ier)
    {
        ...
        T_real fv1[5], fv2[5], fv3[5], fv4[5], savfun[21];
        T_real absc, centr, dhlgth;
        T_real fcentr, fval, fval1, fval2, hlgth;
        T_real result, res10, res21, res43, res87;
        T_real resabs, resasc, reskh;
        int ipx, k, l;
