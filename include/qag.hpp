...
namespace quadpack {
    ...
    T_real Quadpack<T_fun, T_param, T_real>::qag(T_fun f, T_param user_data[], T_real a, T_real b, T_real epsabs, T_real epsrel, int irule, T_real* abserr, int* neval, int* ier)
    {
        T_real result;
        int last;
