...
namespace quadpack {
        ...
        T_real* resabs, T_real* resasc, int* momcom, T_real** chebmo)
    {
        ...
        T_real ac, an, an2, as, asap, ass, centr, conc, cons, cospar;
        T_real estc, ests, hlgth, parint, par2, par22;
        T_real resc12, resc24, ress12, ress24, result, sinpar;
        T_real cheb12[13], cheb24[25], d[28], d1[28], d2[28];
        T_real d3[28], fval[25], v[28];
        int unitialized_value = 0xCCCCCCCC;
        T_real p2 = unitialized_value, p3 = unitialized_value, p4 = unitialized_value;
        ...
        result = gk15w(f, user_data, qwgto<T_real>, omega, p2, p3, p4, sincos, a, b,
