...
namespace quadpack {
        ...
        int* krul, int* neval)
    {
        ...
        T_real ak22, amom0, amom1, amom2, cc, centr;
        T_real cheb12[13], cheb24[25], fval[25];
        T_real hlgth, resabs, resasc, res12, res24, u, result;
        int i, isym, k;
        ...
        (*krul)--;
        result = gk15w(f, user_data, qwgtc<T_real>, c, p2, p3, p4, kp, a, b, abserr, &resabs, &resasc);
        *neval = 15;
