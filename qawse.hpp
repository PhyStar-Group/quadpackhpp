 ...
 *
 *      a   - T_real lower limit of integration.
 *
...
namespace quadpack {
        ...
        int* neval, int* ier)
    {
        ...
        T_real ri[25], rj[25], rh[25], rg[25];
        T_real area, area1, area12, area2, a1, a2, b1, b2, centre;
        T_real errbnd, errmax, error1, erro12, error2, errsum;
        T_real resas1, resas2, result;
        ...
        *ier = 0;
        ...
        centre = 0.5 * (a + b);
        area1 = qc25s(f, user_data, a, b, a, centre, alfa, beta, ri, rj, rg, rh, &error1,
            &resas1, wgtfunc, &nev);
        *neval = *neval + nev;
        area2 = qc25s(f, user_data, a, b, centre, b, alfa, beta, ri, rj, rg, rh, &error2,
            &resas2, wgtfunc, &nev);
        *neval = *neval + nev;
        result = area1 + area2;
        *abserr = error1 + error2;
        ...
        for (last = 2; last < limit; last++) {
            ...
            area1 = qc25s(f, user_data, a, b, a1, b1, alfa, beta, ri, rj, rg, rh, &error1,
                &resas1, wgtfunc, &nev);
            *neval = *neval + nev;
            area2 = qc25s(f, user_data, a, b, a2, b2, alfa, beta, ri, rj, rg, rh, &error2,
                &resas2, wgtfunc, &nev);
            *neval = *neval + nev;
